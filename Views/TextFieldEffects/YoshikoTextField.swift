...
open class YoshikoTextField: TextFieldEffects {
    ...
    private let textFieldInsets = CGPoint(x: 8, y: 0)
    private let placeHolderInsets = CGPoint(x: 8, y: 1)
     ...
     */
     open var borderSize: CGFloat = 2.0 {
        didSet {
            updateBorder()
        }
    }
     ...
     */
     dynamic open var activeBorderColor: UIColor = .clear {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
    ...
    /**
     ...
     This property applies a color to the edges of the control. The default value for this property is a clear color.
     */
     dynamic open var inactiveBorderColor: UIColor = .clear {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
     ...
     */
     dynamic open var activeBackgroundColor: UIColor = .clear {
        didSet {
            updateBackground()
        }
    }
     ...
     */
     dynamic open var placeholderFontScale: CGFloat = 0.9 {
        didSet {
            updatePlaceholder()
        }
    }
